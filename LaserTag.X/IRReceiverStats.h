...
const volatile uint8_t RECEIVER_PULSE_LENGTH_BIAS_UPPER_BOUND_MOD_CYCLES_eval = RECEIVER_PULSE_LENGTH_BIAS_UPPER_BOUND_MOD_CYCLES;
const volatile uint8_t RECEIVER_PULSE_LENGTH_BIAS_LOWER_BOUND_MOD_CYCLES_eval = RECEIVER_PULSE_LENGTH_BIAS_LOWER_BOUND_MOD_CYCLES;
#endif
