...
#include <stdint.h>
const int32_t TSOP2240_MODULATION_FREQ_eval = TSOP2240_MODULATION_FREQ;
const int8_t TSOP2240_PULSE_MIN_CYCLES_eval = TSOP2240_PULSE_MIN_CYCLES;
const int8_t TSOP2240_GAP_MIN_CYCLES_eval = TSOP2240_GAP_MIN_CYCLES;
const int32_t MODULATION_FREQ_eval = MODULATION_FREQ;
const int8_t MODULATION_PERIOD_US_eval = MODULATION_PERIOD_US;
const int8_t ZERO_PULSE_LENGTH_MOD_CYCLES_eval = ZERO_PULSE_LENGTH_MOD_CYCLES;
const int8_t ONE_PULSE_LENGTH_MOD_CYCLES_eval = ONE_PULSE_LENGTH_MOD_CYCLES;
const int8_t PULSE_GAP_LENGTH_MOD_CYCLES_eval = PULSE_GAP_LENGTH_MOD_CYCLES;
const int16_t ZERO_PULSE_LENGTH_US_eval = ZERO_PULSE_LENGTH_US;
const int16_t ONE_PULSE_LENGTH_US_eval = ONE_PULSE_LENGTH_US;
const int16_t PULSE_GAP_LENGTH_US_eval = PULSE_GAP_LENGTH_US;
const int16_t MIN_TRANSMISSION_GAP_LENGTH_US_eval = MIN_TRANSMISSION_GAP_LENGTH_US;
const int8_t TRANSMISSION_DATA_LENGTH_eval = TRANSMISSION_DATA_LENGTH;
#endif
