...
#include <stdint.h>
const int32_t TMR2_FREQ_eval = TMR2_FREQ;
const int8_t TMR2_PERIOD_US_eval = TMR2_PERIOD_US;
const int16_t TRANSMITTER_TIMING_ADJUSTMENT_US_eval = TRANSMITTER_TIMING_ADJUSTMENT_US;
const int16_t PULSE_GAP_LENGTH_TMR2_CYCLES_eval = PULSE_GAP_LENGTH_TMR2_CYCLES;
const int16_t ZERO_PULSE_LENGTH_TMR2_CYCLES_eval = ZERO_PULSE_LENGTH_TMR2_CYCLES;
const int16_t ONE_PULSE_LENGTH_TMR2_CYCLES_eval = ONE_PULSE_LENGTH_TMR2_CYCLES;
#endif
