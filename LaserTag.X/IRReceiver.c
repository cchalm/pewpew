...
#include <stdint.h>
const int32_t TMR1_FREQ_eval = TMR1_FREQ;
const int8_t TMR1_PERIOD_US_eval = TMR1_PERIOD_US;
const int16_t PULSE_GAP_LENGTH_TMR1_CYCLES_eval = PULSE_GAP_LENGTH_TMR1_CYCLES;
const int16_t ZERO_PULSE_LENGTH_TMR1_CYCLES_eval = ZERO_PULSE_LENGTH_TMR1_CYCLES;
const int16_t ONE_PULSE_LENGTH_TMR1_CYCLES_eval = ONE_PULSE_LENGTH_TMR1_CYCLES;
const int16_t MIN_TRANSMISSION_GAP_LENGTH_TMR1_CYCLES_eval = MIN_TRANSMISSION_GAP_LENGTH_TMR1_CYCLES;
const int16_t PULSE_LENGTH_BIAS_US_eval = PULSE_LENGTH_BIAS_US;
const int16_t PULSE_LENGTH_BIAS_TMR1_CYCLES_eval = PULSE_LENGTH_BIAS_TMR1_CYCLES;
const int16_t PULSE_LENGTH_EPSILON_US_eval = PULSE_LENGTH_EPSILON_US;
const int16_t PULSE_LENGTH_EPSILON_TMR1_CYCLES_eval = PULSE_LENGTH_EPSILON_TMR1_CYCLES;
const int16_t PULSE_GAP_UPPER_LENGTH_TMR1_CYCLES_eval = PULSE_GAP_UPPER_LENGTH_TMR1_CYCLES;
const int16_t PULSE_GAP_LOWER_LENGTH_TMR1_CYCLES_eval = PULSE_GAP_LOWER_LENGTH_TMR1_CYCLES;
const int16_t ZERO_PULSE_UPPER_LENGTH_TMR1_CYCLES_eval = ZERO_PULSE_UPPER_LENGTH_TMR1_CYCLES;
const int16_t ZERO_PULSE_LOWER_LENGTH_TMR1_CYCLES_eval = ZERO_PULSE_LOWER_LENGTH_TMR1_CYCLES;
const int16_t ONE_PULSE_UPPER_LENGTH_TMR1_CYCLES_eval = ONE_PULSE_UPPER_LENGTH_TMR1_CYCLES;
const int16_t ONE_PULSE_LOWER_LENGTH_TMR1_CYCLES_eval = ONE_PULSE_LOWER_LENGTH_TMR1_CYCLES;
#endif
